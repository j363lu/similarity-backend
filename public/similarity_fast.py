...
def report(file_name, database_name, similarity_index, articles_similarity, report_text):
    # styles
    pdf_name = 'report.pdf'
...
def sim(file_name, raw_sample, database_name):
    ...
    # create report pdf
    report(file_name, database_name, similarity_index, articles_similarity, report_text)  
